 ...
 * true if they match:
 */
public class BayesTestMapper extends
	...
	protected void setup(Context context) throws IOException,
		...
		boolean compl = Boolean.parseBoolean(conf
				.get(TestNaiveBayesDriver.COMPLEMENTARY));
		if (compl) {
	...
	protected void map(Text key, VectorWritable value, Context context)
		...
		context.write(new Text(SLASH.split(key.toString())[1]),
				new VectorWritable(r));
	}
}
